...
```bash
# < go 1.17 
go get -u github.com/jslyzt/tarsgo/tars/tools/tarsgo
# >= go 1.17
go install github.com/jslyzt/tarsgo/tars/tools/tarsgo@latest
```
...
Flags:
  ...
  -r, --repo-url string   layout repo (default "https://github.com/jslyzt/tarsgo.git")
...
🚀 Creating server TeleSafe.PhonenumSogouServer, layout repo is https://github.com/jslyzt/tarsgo.git, please wait a moment.

正克隆到 '/Users/xxx/.tarsgo/repo/github.com/jslyzt/tarsgo@main'...
