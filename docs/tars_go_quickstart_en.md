...
Install tars:  `go get github.com/jslyzt/tarsgo/tars `

Compile the tars protocol to Golang tool:

```shell
cd $GOPATH/src/github.com/jslyzt/tarsgo/tars/tools/tars2go && go build . 
...
```shell
chmod +x $GOPATH/src/github.com/jslyzt/tarsgo/tars/tools/create_tars_server.sh
$GOPATH/src/github.com/jslyzt/tarsgo/tars/tools/create_tars_server.sh [App] [Server] [Servant]
E.g:  
$GOPATH/src/github.com/jslyzt/tarsgo/tars/tools/create_tars_server.sh TestApp HelloGo SayHello
```
...
```shell
[root@1-1-1-1 ~]# sh $GOPATH/src/github.com/jslyzt/tarsgo/tars/tools/create_tars_server.sh TestApp HelloGo SayHello
